...
# print(Fore.RED, st.session_state.tnved_1_df)
# print(Fore.YELLOW, st.session_state.tnved_2_df)
# print(Fore.GREEN, st.session_state.tnved_3_df)
# print(Fore.BLUE, st.session_state.tnved_4_df, Fore.WHITE)
